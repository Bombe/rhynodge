/*
 * Rhynodge - PirateBayEpisodeWatcher.java - Copyright © 2013 David Roden
 *
 ...
 */
public class PirateBayEpisodeWatcher extends DefaultWatcher {

	/**
	 * Creates a new Pirate Bay episode watcher.
	 *
	 * @param searchTerms
